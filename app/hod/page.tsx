        ...
        <article className="rounded-2xl bg-white p-4 shadow-sm sm:p-6">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link
              ...
              className="text-sm font-semibold text-[#2e63e5]"
            >
              View all
            </Link>
          </div>
              ...
              <tbody>
                {pendingRows.map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="px-2 py-3">
                      <Link
                        href="/hod/pending-reviews/submission"
                        className="rounded-lg border border-[#bad4ff] bg-[#eaf2ff] px-4 py-1.5 text-sm text-[#2e63e5]"
                      >
                        Review
                      </Link>
                    </td>
        ...
        <div className="space-y-4">
          <article className="rounded-2xl bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 flex flex-col items-center gap-4 sm:flex-row sm:items-start">
              ...
              >
                <div className="grid size-28 place-items-center rounded-full bg-white text-4xl font-semibold">
                  25
                </div>
              </div>
              <div className="space-y-3 pt-2 text-sm">
                ...
                <p className="flex items-center gap-2">
                  <span className="size-2.5 rounded-full bg-[#f59e0b]" />8
                  Pending
                </p>
                <p className="flex items-center gap-2">
                  <span className="size-2.5 rounded-full bg-[#ef4444]" />3
                  Rejected
                </p>
              </div>
            </div>
          ...
          <article className="rounded-2xl bg-white p-5 shadow-sm">
            ...
            <div className="mt-4 space-y-2.5 text-sm">
              ...
              >
                <p className="font-semibold">Review Pending Submissions</p>
              ...
              <Link
                ...
                className="block rounded-xl border border-slate-200 p-3 hover:bg-slate-50"
              >
                <p className="font-semibold">Generate Graduation Report</p>
                <p className="text-slate-500">Create eligibility reports</p>
              </Link>
              <Link
                href="/hod/student-records"
                className="block rounded-xl border border-slate-200 p-3 hover:bg-slate-50"
              >
                <p className="font-semibold">View Eligible Students</p>
                <p className="text-slate-500">324 students ready to graduate</p>
              </Link>
              <Link
                href="/hod/reports"
                className="block rounded-xl border border-slate-200 p-3 hover:bg-slate-50"
              >
                ...
                <p className="text-slate-500">Download Excel or PDF reports</p>
              </Link>
            </div>
          </article>
        </div>
