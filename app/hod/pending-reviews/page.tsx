...
import { HodSessionBadge } from "@/app/_components/session-badge";
    ...
    <div className="space-y-6">
      <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_auto]">
        ...
        <div className="self-center justify-self-start lg:justify-self-end">
          <button
            type="button"
            className="h-10 rounded-lg border border-[#3a70ec] px-5 text-sm text-[#3a70ec]"
          >
            All levels
          </button>
        </div>
          ...
          <table className="min-w-full text-left text-sm">
            ...
            <tbody>
              {rows.map((row, idx) => (
                ...
                >
                  {row.map((cell) => (
                    <td key={cell} className="px-2 py-4">
                      {cell}
                    </td>
                  ))}
                  ...
                  <td className="px-2 py-4">
                    <Link
                      ...
                      className="rounded-lg border border-[#bfd7ff] bg-[#edf4ff] px-4 py-1.5 text-sm text-[#2e63e5]"
                    >
                      Review
                    </Link>
                  </td>
