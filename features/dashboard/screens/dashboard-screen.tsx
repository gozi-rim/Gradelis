...
export function DashboardScreen() {
  return (
    <PortalShell
      title="Dashboard"
      rightSlot={
        <div className="hidden items-center gap-3 rounded-xl px-3 py-2 sm:flex">
          <div className="size-10 rounded-full bg-[url('https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=150&auto=format&fit=crop')] bg-cover bg-center" />
          <div>
            <p className="text-base font-semibold text-slate-800">
              Dr Victor Odoi
            </p>
            <p className="text-sm text-slate-500">Course advisor</p>
          </div>
        </div>
      }
    >
