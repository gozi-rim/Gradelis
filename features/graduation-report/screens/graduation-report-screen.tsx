...
export function GraduationReportScreen() {
  return (
    <PortalShell title="Graduation Report">
      <div className="space-y-7">
        <section className="flex flex-wrap items-center justify-between gap-3">
          <button type="button" className="h-11 rounded-lg border border-slate-600 bg-white px-8 text-lg font-medium text-slate-800">
            U2021 Report
          </button>
          <button type="button" className="h-12 rounded-xl bg-[#2e63e5] px-8 text-lg font-semibold text-white">
            Download
          </button>
        </section>
          ...
          <article className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="flex items-start justify-between">
              <div>
                ...
                <button type="button" className="mt-4 h-11 rounded-lg border border-slate-300 px-5 text-base text-slate-700">
                  View Eligible List
                </button>
              </div>
        ...
        <section className="grid gap-4 rounded-2xl bg-white p-6 shadow-sm lg:grid-cols-2">
          <article className="space-y-6 lg:pr-6 lg:border-r lg:border-slate-200">
              ...
              {[
                ...
                <div key={label as string} className="grid grid-cols-[1fr_1fr_auto] items-center gap-3">
                  ...
                  <div className="h-2 rounded-full bg-slate-200">
                    <div className="h-2 rounded-full bg-[#ff6f0f]" style={{ width: width as string }} />
                  </div>
          ...
          <article>
            ...
            <div className="mt-6 flex flex-col items-center gap-5 sm:flex-row sm:items-start">
              <div
                ...
                style={{ background: "conic-gradient(#57c4b4 0 55%, #ff7c16 55% 100%)" }}
              >
                <div className="grid size-36 place-items-center rounded-full bg-white text-center">
                  <p className="text-5xl font-semibold text-slate-800">255</p>
                  <p className="text-lg text-slate-400">Total Students</p>
                </div>
              </div>
